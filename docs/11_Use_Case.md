usecaseDiagram actor Farmer as "Farmer/Producer" actor Logistics as "Logistics Provider" actor Inspector as "Quality Inspector" actor Retailer as "Retailer"package "Food Traceability System" {
